...
public class CommentRecetteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //on récupère le numéro de la recette que l'utilisateur vient de réaliser
        numeroRecette= messagedeRecetteActivity.getIntExtra("numero recette", numeroRecette);
        commentaireRecetteEditText=findViewById(R.id.editTextCommentaireRecette);
        commentaireRecette=commentaireRecetteEditText.getText().toString();
    }
    ...
    public void enregistrer(View view){
        ...
        String numeroRecetteFaite=Integer.toString(numeroRecette);
        //editor.putFloat(numeroRecetteFaite, note); //on met dans shared preferences la note avec l'étiquette correspondant au numero de recette
        //editor.putString(numeroRecetteFaite, commentaireRecette);
        editor.apply();
